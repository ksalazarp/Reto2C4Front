...
const getInfoUser = (idUser) => {
    ...
    $.ajax({
        url: "http://193.122.146.107:8080/api/user/" +idUser,
        type: 'GET',
        dataType: 'json',
...
function checkOrders(getZona){
        ...
        $.ajax({
            url: 'http://193.122.146.107:8080/api/order/zona/'+getZona,
            type: 'GET',
            dataType: 'json',
...
function showDetailOrder(idOrder,getZone){
    ...
    $.ajax({
        url: 'http://193.122.146.107:8080/api/order/'+idOrder,
        type: 'GET',
        dataType: 'json',
...
function update(idOrder, estado, respuesta, getZone){
    ...
    if(estado === ""){
        ...
        $.ajax (
                    {
                        url: "http://193.122.146.107:8080/api/order/update",
                        type         : 'PUT',
                        data         :  datosEnvio,
